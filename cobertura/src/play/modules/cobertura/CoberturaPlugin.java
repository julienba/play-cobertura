...
public class CoberturaPlugin extends PlayPlugin {
	...
	public static String forceInit(){
		...
		File tmpDir = Play.tmpDir;
		if(tmpDir != null && tmpDir.exists()){
			File tmpDevDir = new File(tmpDir.getAbsolutePath() + "/bytecode" + "/DEV");
			
			if(tmpDevDir.exists()){
				File[] fileList = tmpDevDir.listFiles();
				for (File file : fileList) {
					file.delete();
				} 
			}else{
				Logger.info("Tmp dir %s does not exist", tmpDevDir.getAbsolutePath());
			}
		}		
